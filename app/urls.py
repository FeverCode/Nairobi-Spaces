...
from . import views
from app.views import PasswordTokenCheckAPI,RequestPasswordResetEmail, ReservationList, SetNewPasswordAPIView, SpacesListAPIView, VerifyEmail, RegisterView, GoogleSocialAuthView
